            ...
            <div class="slid">
                ...
                <ul class="sidebar">
                    ...
                    <li><span> <i class="fas fa-parachute-box"></i>Otros Servicios</span>
                        <ul class="submenu">
                            <li><a href="roomsDelete.php"><i class="fas fa-address-card"></i>Empleados Eliminados</a></li>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="../controller/ClienteCreate.php" method="post">
                                        <div class="modal-body">

                                            <div class="form-group">
                                                <label for="pasaporte">Numero de Pasaporte</label>
                                                <input type="text" class="form-control" name="pasaporte" pattern="[A-Za-z0-9_-]{1,15}" required>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="modal fade" id="exampleModalM" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="../controller/ClienteEdit.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="Editarsexo" name="Editarsexo">
                                                <option value="">Seleccionar Opcion</option>
                                                <option value="Masculino">Masculino</option>
                                                <option value="Femenino">Femenino</option>
                                            </select>
