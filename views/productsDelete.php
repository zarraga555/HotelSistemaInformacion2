...
?>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main_content">
                ...
                <div class="info cointainer justify-content-center">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalCenterTitle">Restaurado Producto</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form action="../controller/ProductRestore.php" method="post">
                                    <div class="modal-body">
                                        <input type="hidden" class="form-control" name="EliminarCi" id="EliminarCi" required readonly>
                                        ¿Estas seguro que deseas restaura el Producto?
                                    </div>
                    ...
                    <!-- FINAL DEL MODAL DE RESATURADO LOGICO-->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            ...
                            $sql = "SELECT producto.codigo, producto.nombre , proveedores.nombres, producto.compra, producto.venta, producto.cantidad, producto.fechaVencimiento, producto.proveedor FROM producto, proveedores WHERE producto.proveedor = proveedores.nit AND producto.estado = 0";
                                ...
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-success btn-success btn-success2 fas fa-pen" data-toggle="modal" data-target="#exampleModalCenter" onclick="RestauararDatos('<?php echo $ver[0] ?>')"></button>
        ...
        <script type="text/javascript">
            function RestauararDatos(idempleado) {
